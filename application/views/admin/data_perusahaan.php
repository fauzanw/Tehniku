    <div class="container-fluid mt--7">
      ...
      <div class="card shadow-lg mb-5">
        <div class="card-header border-0 d-sm-flex align-items-center justify-content-between mb-4">
            <h3 class="text-dark mb-0">Data Perusahaan</h3>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    <?php $i = 1;foreach($data_perusahaan as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" name="is_blocked"  class="form-check-input is_blocked" name="is_blocked"  <?= ($data['is_blocked']) == 1 ? "checked":null; ?> data-id="<?= $data['user_id'] ?>">
                                </div>
                            </td>
                            <td class='text-right'> 
                                <div class="dropdown">
