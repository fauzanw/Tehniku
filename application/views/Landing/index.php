...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/landing') ?>/css/templatemo-lava.css">
    ...
    <section class="section" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <h2>01</h2>
                            <img src="assets/landing/images/jasa/ac.png" style="width: 100px;height:100px;" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <h2>02</h2>
                            <img src="assets/landing/images/jasa/alarm.png" style="width: 110px;height:100px;" alt="">
                            <h4>Alarm</h4>
                            <p>Curabitur pulvinar vel odio sed sagittis. Nam maximus ex diam, nec consectetur diam.</p>
                            <a href="#testimonials" class="main-button">
                            Lihat Lebih Lanjut
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <h2>03</h2>
                            <img src="assets/landing/images/jasa/cctv.png" style="width: 100px;height:100px;" alt="">
                            <h4>CCTV</h4>
                            <p>Curabitur pulvinar vel odio sed sagittis. Nam maximus ex diam, nec consectetur diam.</p>
                            <a href="#testimonials" class="main-button">
                                Lihat Lebih Lanjut
            ...
            <center style="margin-top: 25px">
                <a href="#about" class="main-button-slider">Lihat jasa yang lainnya</a>
            </center>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="left-image col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="assets/landing/images/left-image.png" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
                <div class="right-text offset-lg-1 col-lg-6 col-md-12 col-sm-12 mobile-bottom-fix">
                    <ul>
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                            <img src="assets/landing/images/about-icon-01.png" alt="">
                            <div class="text">
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.5s">
                            <img src="assets/landing/images/about-icon-02.png" alt="">
                            <div class="text">
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.6s">
                            <img src="assets/landing/images/about-icon-03.png" alt="">
                            <div class="text">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="assets/landing/images/testimonial-author-1.png" alt="Author One"></i>
                            </div>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="assets/landing/images/testimonial-author-1.png" alt="Author Third"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="assets/landing/images/testimonial-author-1.png" alt="Fourth Author"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 offset-lg-">
                    <div class="center-heading">
                        <h2>Bergabung & menggunakan <em>Tehniku</em></h2>
                        <p>Mari bergabung dan menggunakan jasa kami dengan mudah dan cepat</p>
                    </div>
                </div>
                <div class="col-lg-10 col-md-12 col-sm-12 mobile-bottom-fix-big">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="features-item">
                                <div class="features-icon">
                                    <h2>01</h2>
                                    <img src="assets/landing/images/join/perusahaan.png" style="width: 130px;height:120px;" alt="">
                                    <h4>Perusahaan</h4>
                                    <p>Kamu bisa mendaftarkan perusahaan kamu, dan menambahkan jasa</p>
                                    <a href="<?= base_url('auth/perusahaan/register') ?>" class="main-button btn-block">
