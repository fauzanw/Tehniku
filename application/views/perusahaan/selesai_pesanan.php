      ...
      <div class="row">
        ...
        <div class="col-md-5 mb-5">
            <div class="card shadow-lg">
                ...
                <center>
                    <img src="<?= base_url('assets/argon/img/customer/') . $data_pesanan['foto_customer'] ?>" alt="" style="width: 30%;height: 30%;" class="img-thumbnail img-fluid card-img-top mt-2">
                </center>
                    <div class="row">
                        <div class="col-md-8">
    ...
    <center class="wow bounce pb-4 mt--2" data-wow-duration="2s">
      ...
      <h2 class="mt-2">Pesanan ini telah selesai!</h2>
    </center>
                ...
                <div class="modal-body">
                        ...
                        <table class="table table-reponsive table-hover dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['nama']; ?></td>
                                    <td>
                                        <input type="checkbox" id="id_pegawai" disabled name="id_pegawai[]" value="<?= $data['id'] ?>">
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <?php else: ?>
                        <div class="container text-center">
                            <img src="<?= base_url('assets/argon/img/theme/empty.svg') ?>" class="img-fluid" width="240" height="240" alt="">
